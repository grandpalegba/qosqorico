// ============================================================
// SERIES QUESTIONS — vraie valeur éditoriale, conservée intacte
// ============================================================
...
"Demo: El Ombligo del Mundo": [
  "¿Cuál es la piedra o muro específico que más te conecta con el pasado inca?",
  "Cuéntanos una historia sobre cómo la energía de esta ciudad cambió tu forma de ver el mundo.",
  "Si pudieras retroceder 500 años, ¿qué pregunta le harías a los constructores de este lugar?",
  "¿Cómo explicas a alguien que no conoce Cusco por qué este sitio es el verdadero 'centro'?"
],
"Demo: Frutos de Altura": [
  "¿Cuál es el alimento andino más sorprendente que has probado en un mercado local?",
  "¿Cómo fue la experiencia de comprar ingredientes en Pisac para cocinar algo nuevo?",
  "Cuéntanos una historia sobre cómo un fruto de altura te salvó el día.",
  "¿Qué es lo que más extrañas del sabor de los productos de Cusco cuando viajas?"
],
"Demo: Ecos del Viento": [
  "¿Cuál es el sonido que más te conecta con el espíritu de los Andes?",
  "¿Cómo fue la experiencia de sanación a través del sonido que más te impactó?",
  "¿Qué emoción despertó en ti una flauta de bambú en medio del silencio de la montaña?",
  "Cuéntanos sobre una vez que el sonido te transportó a otro lugar y tiempo."
...
// ============================================================
// DEMO PROVIDERS — 4 profils statiques pour tester l'expérience
// Les providers réels viennent de Supabase via useProviders hook
// ============================================================
export const DEMO_PROVIDERS = [
  {
    id: "demo-maria",
    user_id: null,
    display_name: "María Mamani",
    tagline: "Tejedora ancestral y guardiana del hilo inca",
    bio: "María nació en Chinchero y aprendió el arte del tejido a los 6 años de manos de su abuela. Sus obras son puentes entre el pasado y el presente andino. Cada hilo que teje cuenta una historia de más de 500 años.",
    location: "Chinchero, Cusco",
    poster_url: "https://images.unsplash.com/photo-1531746790095-e16def12e1cd?w=600&h=900&fit=crop&crop=faces",
    series_name: "Demo Qosqorico",
    suyu_id: "demo",
    price_per_session: 45,
    duration_minutes: 90,
    languages: ["Español", "Quechua"],
    is_demo: true,
    episodes: SERIES_QUESTIONS["Demo: Hilos del Inca"].map((q, i) => ({
      title: q,
      subtitle: `Episodio ${i + 1}`,
      thumbnail_url: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=400&h=700&fit=crop",
      duration: ["3:24", "4:12", "5:01", "2:48"][i]
    })),
    services: [
      { name: "Clase Magistral de Telar", description: "3 horas de inmersión en el arte del telar de cintura.", price: 45, currency: "USD", duration: "3 horas" },
      { name: "Tour Textil Chinchero", description: "Visita guiada al taller y demostración de tintes naturales.", price: 25, currency: "USD", duration: "2 horas" }
    ]
  },
  {
    id: "demo-carlos",
    user_id: null,
    display_name: "Carlos Apaza",
    tagline: "Arqueólogo y narrador de piedras milenarias",
    bio: "Carlos lleva 20 años excavando y documentando sitios incas. Convierte cada visita en una historia que nunca olvidarás. Su especialidad es revelar los secretos matemáticos de la arquitectura inca.",
    location: "Cusco, Perú",
    poster_url: "https://images.unsplash.com/photo-1607990281513-2c110a25bd8c?w=600&h=900&fit=crop&crop=faces",
    series_name: "Demo Qosqorico",
    suyu_id: "demo",
    ...
    is_demo: true,
    episodes: SERIES_QUESTIONS["Demo: El Ombligo del Mundo"].map((q, i) => ({
      title: q,
      subtitle: `Episodio ${i + 1}`,
      thumbnail_url: "https://images.unsplash.com/photo-1526392060635-9d6019884377?w=400&h=700&fit=crop",
      duration: ["2:48", "3:35", "4:20", "3:55"][i]
    })),
    services: [
      { name: "Tour Arqueológico Privado", description: "Visita exclusiva a sitios incas con interpretación profunda.", price: 60, currency: "USD", duration: "3 horas" },
      { name: "Conferencia Historia Inca", description: "Sesión magistral con proyección y artefactos reales.", price: 40, currency: "USD", duration: "1.5 horas" }
    ]
  },
  {
    id: "demo-lucia",
    user_id: null,
    display_name: "Lucía Cusihuamán",
    tagline: "Cocinera de altura y alquimista de sabores andinos",
    bio: "Lucía transforma los productos del mercado de San Pedro en experiencias culinarias únicas. Cada plato es un viaje a los Andes. Especialista en superfoods andinos y cocina de altura.",
    location: "Cusco, Perú",
    poster_url: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=600&h=900&fit=crop&crop=faces",
    series_name: "Demo Qosqorico",
    suyu_id: "demo",
    ...
    is_demo: true,
    episodes: SERIES_QUESTIONS["Demo: Frutos de Altura"].map((q, i) => ({
      title: q,
      subtitle: `Episodio ${i + 1}`,
      thumbnail_url: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=400&h=700&fit=crop",
      duration: ["3:10", "4:05", "3:45", "2:30"][i]
    })),
    services: [
      { name: "Clase de Cocina Andina", description: "Aprende a cocinar 4 platos tradicionales con ingredientes locales.", price: 55, currency: "USD", duration: "3 horas" },
      { name: "Tour Mercado San Pedro", description: "Visita guiada al mercado y degustación de productos locales.", price: 30, currency: "USD", duration: "1.5 horas" }
    ]
  },
  {
    id: "demo-diego",
    user_id: null,
    display_name: "Diego Quispe",
    tagline: "Músico andino y maestro de instrumentos sagrados",
    bio: "Diego toca la quena y el charango desde los 8 años. Sus sesiones de sonido son ceremonias de sanación vibratoria donde los instrumentos ancestrales dialogan con el espíritu de los Apus.",
    location: "San Blas, Cusco",
    poster_url: "https://images.unsplash.com/photo-1499996860823-5214fcc65f8f?w=600&h=900&fit=crop&crop=faces",
    series_name: "Demo Qosqorico",
    suyu_id: "demo",
    ...
    languages: ["Español", "English"],
    is_demo: true,
    episodes: SERIES_QUESTIONS["Demo: Ecos del Viento"].map((q, i) => ({
      title: q,
      subtitle: `Episodio ${i + 1}`,
      thumbnail_url: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=700&fit=crop",
      duration: ["2:48", "3:24", "4:10", "3:55"][i]
    })),
    services: [
      { name: "Sesión de Sound Healing", description: "1 hora de sanación vibracional con quena, charango y cuencos.", price: 40, currency: "USD", duration: "1 hora" },
      { name: "Taller de Instrumentos Andinos", description: "Aprende los fundamentos de la quena y el charango.", price: 50, currency: "USD", duration: "2 horas" }
    ]
  }
];
...
/** Retourne un provider démo par son id */
export function getDemoProviderById(id) {
  return DEMO_PROVIDERS.find(p => p.id === id) || null;
}

/** Retourne les providers démo pour une série donnée */
export function getDemoProvidersForSeries(seriesName) {
  return DEMO_PROVIDERS.filter(p => p.series_name === seriesName);
}

/** Obtenir les questions d'une série (avec fallback) */
export function getQuestionsForSeries(seriesName) {
  return SERIES_QUESTIONS[seriesName] || FALLBACK_QUESTIONS;
}
